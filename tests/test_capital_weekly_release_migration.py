...
from capital_weekly.release_migration import migrate_releases
...
from tests.test_capital_weekly_weekly_release import (
    FakePipelineRunner,
    write_csv,
...
class ReleaseMigrationTests(unittest.TestCase):
    ...
    def test_formal_migration_lock_rejects_refresh_before_any_pipeline_runs(self):
        ...
        with patch(
            "capital_weekly.release_migration._publish_directory",
