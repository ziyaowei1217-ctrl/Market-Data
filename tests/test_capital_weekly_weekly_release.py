...
from capital_weekly import weekly_release as weekly_release_module
from capital_weekly.weekly_context import CATEGORY_FIELDS
from capital_weekly.weekly_release import (
...
class ReleaseOrchestrationTests(unittest.TestCase):
    ...
    def test_status_uses_execution_clock_not_the_window_override_clock(self):
        ...
        with patch(
            "capital_weekly.weekly_release.datetime",
    ...
    def test_publish_swap_failure_rolls_the_prior_release_back(self):
        ...
        with patch(
            "capital_weekly.weekly_release.os.replace",
    ...
    def test_backup_cleanup_failure_does_not_mark_a_published_week_failed(self):
        ...
        with patch(
            "capital_weekly.weekly_release.shutil.rmtree",
    ...
    def test_final_status_write_failure_rolls_the_published_week_back(self):
        ...
        with patch(
            "capital_weekly.weekly_release._atomic_write_json",
