...
from capital_weekly.equity_indices import fetch_equity_indices
...
def main() -> None:
    ...
    parser.add_argument(
        "--universe",
        default="data/capital_weekly_equity_indices.csv",
    ...
    data, source_log = fetch_equity_indices(args.universe, raw_dir=raw_dir)
