...
from pipeline.capital_weekly.context.providers import build_default_providers
from pipeline.capital_weekly.equity_indices import load_index_universe
from pipeline.capital_weekly.equity_sectors import load_sector_universe as load_equity_sectors
from pipeline.capital_weekly.gics_sectors import load_sector_universe as load_gics_sectors
from pipeline.capital_weekly.macro_assets import load_macro_asset_universe
from pipeline.common import DEFAULT_CONFIG_PATH, load_config_rows
