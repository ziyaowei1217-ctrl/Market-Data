...
from pipeline.capital_weekly import equity_indices
from pipeline.capital_weekly.equity_indices import (
    IndexConfig,
...
class EquityIndexFetcherTests(unittest.TestCase):
    def test_fetcher_applies_as_of_cutoff_before_snapshot_calculation(self):
        with tempfile.TemporaryDirectory() as directory:
            ...
            with patch(
                "pipeline.capital_weekly.equity_indices.fetch_history",
