...
from pipeline.internal.capital_weekly.gics_sectors import fetch_gics_sectors, load_sector_universe
...
class GicsSectorFetchTests(unittest.TestCase):
    def test_fetcher_applies_as_of_cutoff_before_snapshot_calculation(self):
        with TemporaryDirectory() as directory:
            ...
            with patch(
                "pipeline.internal.capital_weekly.gics_sectors.fetch_history",
